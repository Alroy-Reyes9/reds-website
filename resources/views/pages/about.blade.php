...
<section class="section">
  <div class="container about-cols">
    ...
    <div class="values">
      @foreach([
        ['Safety First','Every job planned and executed with strict safety protocols.'],
        ['Quality Work','Only certified materials and proven methods — no shortcuts.'],
        ['Client Focus','Solutions aligned with your budget and operational needs.'],
...
{{-- ACTION SHOTS: all 9 work photos --}}
<section class="section section-alt">
  <div class="container">
    <div class="sec-hdr">
      <span class="label">In the Field</span>
      <h2>Our Team at Work</h2>
      <p>Residential to commercial — from single-room installs to high-bay HVAC builds on scaffolding.</p>
    </div>
    <div class="action-grid">
      {{-- Wide feature shot --}}
      <div class="ap ap--wide">
        <img src="{{ asset('images/hvac-scaffold-install.jpg') }}" alt="HVAC scaffold install commercial">
        <div class="ap-lbl">Commercial HVAC scaffold installation</div>
      </div>
      <div class="ap">
        <img src="{{ asset('images/ceiling-duct-wiring.jpg') }}" alt="Ceiling duct routing">
        <div class="ap-lbl">Ceiling duct & electrical routing</div>
      </div>
      <div class="ap">
        <img src="{{ asset('images/commercial-hvac-scaffold.jpg') }}" alt="Commercial ceiling HVAC">
        <div class="ap-lbl">Commercial ceiling HVAC work</div>
      </div>

      {{-- Second wide --}}
      <div class="ap ap--wide">
        <img src="{{ asset('images/floor-mounted-install.jpg') }}" alt="Floor-mounted HVAC unit">
        <div class="ap-lbl">Floor-mounted unit installation</div>
      </div>
      <div class="ap">
        <img src="{{ asset('images/install-outdoor-unit.jpg') }}" alt="Team outdoor unit lift">
        <div class="ap-lbl">Outdoor unit team positioning</div>
      </div>
      <div class="ap">
        <img src="{{ asset('images/indoor-unit-repair.jpg') }}" alt="Indoor unit service">
        <div class="ap-lbl">Indoor unit service & repair</div>
      </div>

      {{-- Bottom row --}}
      <div class="ap">
        <img src="{{ asset('images/rooftop-repair.jpg') }}" alt="Rooftop repair">
        <div class="ap-lbl">Rooftop unit maintenance</div>
      </div>
      <div class="ap">
        <img src="{{ asset('images/bracket-install.jpg') }}" alt="Bracket install">
        <div class="ap-lbl">Precision bracket mounting</div>
      </div>
      <div class="ap">
        <img src="{{ asset('images/outdoor-unit-welding.jpg') }}" alt="Outdoor unit pipe connection">
        <div class="ap-lbl">Outdoor unit pipe connection</div>
      </div>
      <div class="ap">
        <img src="{{ asset('images/mitsubishi-indoor-unit.jpg') }}" alt="Mitsubishi installed">
        <div class="ap-lbl">Mitsubishi Heavy Industries split-type</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="team-grid">
      @foreach([
        ...
        ['⚡','Electrical Engineers','Licensed EEs handling power and control systems.'],
